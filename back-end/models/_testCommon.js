...
async function commonBeforeAll() {
    ...
    const users = await db.query(`INSERT INTO users(username, password, first_name, last_name) VALUES ('u1', $1, 'U1F', 'U1L'), ('u2', $2, 'U2F', 'U2L') RETURNING id, username, first_name AS "firstName", last_name AS "lastName"`,[testPass1, testPass2]);
    ...
    breweryIds.splice(0, 0, ...breweries.rows.map(u => u.id))
